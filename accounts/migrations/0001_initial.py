# Generated by Django 2.0.6 on 2018-08-03 18:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_recover_string', models.CharField(default='', max_length=64)),
                ('activation_string', models.CharField(default='', max_length=64)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            name='BenefactorComment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment_string', models.CharField(default='', max_length=2048)),
                ('date_time', models.DateTimeField(auto_now=True)),
                ('ability', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='accounts.Ability')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='ability',
            name='ability_type',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='accounts.AbilityType'),
        ),
        migrations.AddField(
            model_name='user',
            name='contact_info',
